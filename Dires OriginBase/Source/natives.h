...
namespace PLAYER
{
	...
	static Any GIVE_ACHIEVEMENT_TO_PLAYER(int achId) { return invoke<Any>(0xBEC7076D64130195, achId); } // 0xBEC7076D64130195 0x822BC992
...
namespace ENTITY
{
	...
	static void SET_ENTITY_ALPHA(Entity entity, int alphaLevel, int skin) { invoke<Void>(0x44A0870B7E92D7C0, entity, alphaLevel, skin); } // 0x44A0870B7E92D7C0 0xAE667CB0
...
namespace PED
{
	...
	static Any SET_PED_PINNED_DOWN(Ped ped, BOOL pinned, int p2) { return invoke<Any>(0xAAD6D1ACF08F4612, ped, pinned, p2); } // 0xAAD6D1ACF08F4612 0xCC78999D
...
namespace VEHICLE
{
	...
	static Vehicle IS_VEHICLE_DOOR_FULLY_OPEN(Vehicle v, int rwing) { return invoke<Vehicle>(0x3E933CFF7B111C22, v, rwing); } // 0x3E933CFF7B111C22 0xC2385B6F
...
namespace GAMEPLAY
{
	...
	static BOOL _IS_PROJECTILE_TYPE_IN_RADIUS(float x, float y, float z, Hash projHash, float radius, BOOL ownedByPlayer) { return invoke<BOOL>(0x34318593248C8FB2, x, y, z, projHash, radius, ownedByPlayer); } // 0x34318593248C8FB2 0xBE81F1E2
...
namespace AUDIO
{
	...
	static void SET_SIREN_WITH_NO_DRIVER(Object* vehicle, ScrHandle* toggle) { invoke<Void>(0x1FEF0683B96EBCF2, vehicle, toggle); } // 0x1FEF0683B96EBCF2 0x77182D58
...
namespace GRAPHICS
{
	...
	static void _PUSH_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(int value) { invoke<Void>(0xC3D0841A0CC546A6, value); } // 0xC3D0841A0CC546A6 0x716777CB
	static void _PUSH_SCALEFORM_MOVIE_METHOD_PARAMETER_FLOAT(float value) { invoke<Void>(0xD69736AAE04DB51A, value); } // 0xD69736AAE04DB51A 0x9A01FFDA
	static void _PUSH_SCALEFORM_MOVIE_METHOD_PARAMETER_BOOL(BOOL value) { invoke<Void>(0xC58424BA936EB458, value); } // 0xC58424BA936EB458 0x0D4AE8CB
	...
	static void _PUSH_SCALEFORM_MOVIE_METHOD_PARAMETER_STRING(char* value) { invoke<Void>(0xBA7148484BD90365, value); } // 0xBA7148484BD90365 0x4DAAD55B
	static void _PUSH_SCALEFORM_MOVIE_METHOD_PARAMETER_BUTTON_NAME(char* button) { invoke<Void>(0xE83A3E3557A56640, button); } // 0xE83A3E3557A56640 0xCCBF0334
...
namespace NETWORKCASH
{
	...
	static float* _0x6FCF8DDEA146C45B(Any p0) { return invoke<float*>(0x6FCF8DDEA146C45B, p0); } // 0x6FCF8DDEA146C45B 0xB96C7ABE
}
